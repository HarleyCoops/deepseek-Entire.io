...
- **Beautiful UI** is the visual/interaction reference for web or TUI chat presentation (thinking, tools, approval, streaming) ([decision](.agents/notes/implemented/process/2026-08-16-beautiful-ui-visual-reference.md)).
