...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/workspace-alberta': { kind: 'none', reason: 'The glue plugin only rewrites the browser index title; persona, MCP tools, and the Cohere adapter belong to composed system-prompt, mcp-client, and llm-pi-ai rows.' },
