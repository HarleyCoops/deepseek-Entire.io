...
| [`workspace-alberta/`](workspace-alberta/README.md) | WorkspaceAlberta Web box over base + web-app: Cohere, official MCP client, title chrome | mounts `workspace-alberta` |
