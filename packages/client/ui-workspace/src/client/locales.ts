...
export const zh = {
  ...
  'menu.addWorkspace': '选择工作区文件夹',
  'picker.loading': '正在加载工作区…',
  'picker.folderOnly': '仅可选择文件夹；此处无法附加文件。',
  'picker.opening': '正在打开文件夹选择器…',
  'picker.cancelled': '未选择文件夹',
  'picker.dismiss': '关闭',
...
export const en = {
  ...
  'workspace.add': 'Choose workspace folder',
  ...
  'menu.addWorkspace': 'Choose workspace folder',
  'picker.loading': 'Loading workspaces…',
  'picker.folderOnly': 'Folders only; files are not attached here.',
  'picker.opening': 'Opening folder chooser…',
  'picker.cancelled': 'No folder selected',
